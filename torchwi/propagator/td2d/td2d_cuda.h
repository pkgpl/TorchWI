...
__global__ void cuda_exa(float *d_exa, short *d_iexa, float *d_vel,float *d_u1, float *d_u2, float *d_u3, const int dimxy, const int it, const float cons);
__global__ void cuda_crosscorr_exa(float *d_grad, float *d_exa, short *d_iexa, float *d_u3, const int dimxy, const int it);
